-- COMPLETE DEPOSIT SYSTEM FIX
-- This combines the fresh schema + RLS fixes
...
-- Step 4: Create deposit_transactions table for tracking balance updates
...
-- Step 6: Update admin_settings to include new deposit configuration
...
-- Step 7: Set up Row Level Security with WORKING policies
...
-- Step 8: Set up RLS for deposit_transactions
...
-- Step 9: Create storage bucket for deposit proofs (if not exists)
INSERT INTO storage.buckets (id, name, public) 
VALUES ('deposit-proofs', 'deposit-proofs', false)
ON CONFLICT (id) DO NOTHING;

-- Step 10: Storage policies for deposit proofs
...
-- Step 11: Update admin settings with default values
...
-- Step 12: Create the stored procedures for deposit processing
...
-- Step 13: Function to reject deposit
...
DO $$
BEGIN
    RAISE NOTICE 'SUCCESS: Complete deposit system has been set up!';
